...
const __rootRequire = createRequire(import.meta.url);
const __sharpRequire = createRequire(__path.dirname(import.meta.url) + __path.sep + "sharp" + __path.sep + "index.js");
